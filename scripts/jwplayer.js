    ...
    var e, t, n = {
        ...
        1569: (e,t,n)=>{
            ...
            const o = function(e) {
              ...
              , s = function() {
                const e = "//ssl.p.jwpcdn.com/player/v/8.30.0";
                return `${e && (0,
            ...
            const g = e=>"string" == typeof e && /^\/\/(?:content\.jwplatform|cdn\.jwplayer)\.com\//.test(e)
              ...
              , v = e=>{
                const t = "file:" === window.location.protocol ? "https:" : ""
                  , n = {
                    bidding: "//ssl.p.jwpcdn.com/player/v/8.30.0/bidding.js",
                    jwpsrv: "//ssl.p.jwpcdn.com/player/v/8.30.0/jwpsrv.js",
                    dai: "//ssl.p.jwpcdn.com/player/v/8.30.0/dai.js",
                    vast: "//ssl.p.jwpcdn.com/player/v/8.30.0/vast.js",
                    googima: "//ssl.p.jwpcdn.com/player/v/8.30.0/googima.js",
                    freewheel: "//ssl.p.jwpcdn.com/player/v/8.30.0/freewheel.js",
                    gapro: "//ssl.p.jwpcdn.com/player/v/8.30.0/gapro.js",
                    interactive: "//ssl.p.jwpcdn.com/player/v/8.30.0/interactive.js"
                }[e];
                return n ? t + n : ""
            }
              , b = (e,t,n)=>{
            ...
            const c = class {
                constructor(e) {
                    this.keyData = (e=>{
                        ...
                        return {
                            edition: "enterprise",
                            token: "i hope you fucking die",
                            expiration: new Date(8640000000000)
                        }
                    }
                    )(e),
                    ...
                    this.error = function() {
                        let t;
                        return void 0 === e ? null : this.keyData.edition !== l && this.keyData.token ? this.duration() < 0 && (t = a) : t = 100012,
